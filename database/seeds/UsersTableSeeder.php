    ...
    public function run()
    {
        $data = [
            ...
            [
                'role_id' => '100',
                'company_id' => '1',
                'name' => 'Fast Charging\'s Admin 1',
                'email' => 'admin-1@fast-charging.gr',
                'msisdn' => '306900000006',
                'email_verified_at' => date('Y-m-d H:i:s'),
                'password' => 'demo1234',
                'date_format' => DateFormat::$formats[0],
            ...
            [
                'role_id' => '100',
                'company_id' => '1',
                'name' => 'Fast Charging\'s Admin 2',
                'email' => 'admin-2@fast-charging.gr',
                'msisdn' => '306900000007',
                'email_verified_at' => date('Y-m-d H:i:s'),
                'password' => 'demo1234',
                'date_format' => DateFormat::$formats[0],
            ...
            [
                'role_id' => '100',
                'company_id' => '2',
                'name' => 'Electronic Stations\' Admin 1',
                'email' => 'admin-1@electronic-stations.gr',
                'msisdn' => '306900000008',
                'email_verified_at' => date('Y-m-d H:i:s'),
                'password' => 'demo1234',
                'date_format' => DateFormat::$formats[0],
